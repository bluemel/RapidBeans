/*
 * test code file: TestBeanTransient.java
 */
...
public class TestBeanTransient extends RapidBeanImplStrict {
     ...
     * property "children".
     */
    private org.rapidbeans.core.basic.PropertyCollection children;
     ...
     * @param s the string
     */
    public TestBeanTransient(final String s) {
        super(s);
     ...
     */
    public TestBeanTransient(final String[] sa) {
        super(sa);
    }
     ...
     * @param argValue value of Property 'surname' to set
     */
     ...
     * @param argValue value of Property 'prename' to set
     */
    ...
    public final java.util.Collection<org.rapidbeans.test.TestBean> getChildren() {
        try {
            return (java.util.Collection<org.rapidbeans.test.TestBean>)
     ...
     * @param argValue value of Property 'children' to set
     */
    ...
    /**
     * add method for Property 'children'.
    ...
    /**
     * remove method for Property 'children'.
     * @param bean bean to add
     */
