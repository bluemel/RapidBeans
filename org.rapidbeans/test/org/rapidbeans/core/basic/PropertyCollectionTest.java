...
public class PropertyCollectionTest {
    ...
    public void testAddAndRemoveLinkOkComponentTreeSetSorted() {
        ...
        RapidBean adrbook = RapidBean.createInstance("org.rapidbeans.test.addressbook5.Addressbook");
        RapidBean person1 = RapidBean.createInstance("org.rapidbeans.test.addressbook5.Person");
        person1.setPropValue("lastname", "A");
        RapidBean person2 = RapidBean.createInstance("org.rapidbeans.test.addressbook5.Person");
    ...
    public void testAddAndRemoveLinkOkComponentTreeSetSortedChangeProperties() {
        ...
        RapidBean person3 = RapidBean.createInstance("org.rapidbeans.test.addressbook5.Person");
        person3.setPropValue("lastname", "D");
        RapidBean person4 = RapidBean.createInstance("org.rapidbeans.test.addressbook5.Person");
    ...
    public void testSetValueMult1to1Ok() {
        ...
        // set up
        Person martin = new Person("\"Blümel\" \"Martin\" \"19641014\"");
        Person jojo = new Person("\"Blümel\" \"Johannes\" \"19641014\"");
    ...
    public void testAddLinkInvalidMultExceeded() {
        ...
        Address adr = new Address();
        Person jojo1 = new Person("\"Johannes\" \"Blümel\" \"19641014\"");
        Person jojo2 = new Person("\"Johannes\" \"Blümel\" \"19641015\"");
        Person jojo3 = new Person("\"Johannes\" \"Blümel\" \"19641016\"");
        Person jojo4 = new Person("\"Johannes\" \"Blümel\" \"19641017\"");
        Person jojo5 = new Person("\"Johannes\" \"Blümel\" \"19641018\"");
        Person jojo6 = new Person("\"Johannes\" \"Blümel\" \"19641019\"");
    ...
    public void testRemoveLinkComponentDeleteOrphanedFromDoc() {
        ...
        Person martin = new Person(new String[] { "Blümel", "Martin", "19641014" });
        ...
        fasanstreet.setStreet("Fasanenstraße");
    ...
    public void testToStringSingleBean() {
        ...
        PropertyCollection prop = this.createCollectionProperty("<property name=\"test\"" + " targettype=\"TestBean\""
                + " />");
        prop.setValue(bean);
        Assert.assertEquals("Blümel_Martin_19641014", prop.toString());
    }
    ...
    public void testToStringMultipleBeans() {
        RapidBean bean1 = this.createTestBean("Blümel", "Martin", "19641014");
        RapidBean bean2 = this.createTestBean("Blümel", "Ulrike", "19620802");
        ...
        col.add(bean3);
        prop.setValue(col);
        Assert.assertEquals("Blümel_Martin_19641014,Blümel_Ulrike_19620802,Keinki_Katharina_19901119", prop.toString());
    }
    ...
    public void testValidateOk() {
        RapidBean bean = createTestBean("Blümel", "Martin", "19641014");
        PropertyCollection prop = this.createCollectionProperty("<property name=\"test\"" + " targettype=\"TestBean\""
                + " />");
        prop.validate(bean);
    }
...
//    }
    ...
    private GenericBean createTestBean() {
        return this.createTestBean("Blümel", "Martin", "19641014");
    }
