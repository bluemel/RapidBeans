...
public class IdKeypropsTest extends TestCase {
    ...
    public void testToString() {
        GenericBean bean = createTestBean("Blümel", "Martin", "19641014");
        IdKeyprops id = new IdKeyprops(bean, null);
        assertEquals("Blümel_Martin_19641014", id.toString());
    }
    ...
    public void testEqualsEqual() {
        ...
        GenericBean bean2 = createTestBean("Blümel", "Martin", "19641014");
