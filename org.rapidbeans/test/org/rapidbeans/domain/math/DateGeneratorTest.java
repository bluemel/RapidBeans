...
public class DateGeneratorTest extends TestCase {
	 ...
	 *             in case of dateparsing problems
	 */
	public void testGenerateNormal() throws ParseException {
		DateGenerator testGenerator = new DateGenerator();
		ArrayList<Date> dates = testGenerator.generateDays(DFDATE.parse("11.11.2005"), DFDATE.parse("15.11.2005"));
		assertNotNull(dates);
	...
	public void testGenerateFromEqualsTo() throws ParseException {
		DateGenerator testGenerator = new DateGenerator();
		ArrayList<Date> dates = testGenerator.generateDays(DFDATE.parse("11.11.2005"), DFDATE.parse("11.11.2005"));
		assertNotNull(dates);
	...
	public void testGenerateInputDatesNotExact() throws ParseException {
		DateGenerator testGenerator = new DateGenerator();
		ArrayList<Date> dates = testGenerator.generateDays(DFTIME.parse("11.11.2005 23:59:59"),
	...
	public void testGenerateFromSmallerTo() throws ParseException {
		DateGenerator testGenerator = new DateGenerator();
		try {
			testGenerator.generateDays(DFDATE.parse("15.11.2005"), DFDATE.parse("11.11.2005"));
