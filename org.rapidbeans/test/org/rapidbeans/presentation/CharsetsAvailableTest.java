...
public class CharsetsAvailableTest extends TestCase {
	...
	public void testConstants() {
		assertSame(CharsetsAvailable.ISO_8859_1,
				CharsetsAvailable.getInstance("ISO-8859-1"));
		assertSame(CharsetsAvailable.UTF_8,
				CharsetsAvailable.getInstance("UTF-8"));
		assertSame(CharsetsAvailable.UTF_16,
				CharsetsAvailable.getInstance("UTF-16"));
	}
}
