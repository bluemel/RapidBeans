 ...
 * <li><b><code>association (end)</code></b>
 *              a collection of references to other beans (Links)</li>
 * <li><b><code>boolean&nbsp&nbsp&nbsp&nbsp</code></b>a boolean value ('true' or 'false')</li>
 ...
 * <li><b><code>decimal (not yet implemented)&nbsp&nbsp&nbsp&nbsp</code></b>numeric value stored
 *              in decimal format (BigDecimal)</li>
 * <li><b><code>file&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</code></b>File or Directory</li>
 * <li><b><code>float (not yet implemented)&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</code></b>numeric value
 *                stored in floating point format (double)</li>
 * <li><b><code>integer&nbsp&nbsp&nbsp&nbsp</code></b>numeric value stored in integer format (long)</li>
 * <li><b><code>quantity&nbsp&nbsp&nbsp</code></b>quantity consisting in
 *                magnitude (Number) and unit (RapidEnum)</li>
 * <li><b><code>string&nbsp&nbsp;&nbsp&nbsp&nbsp</code></b>
 *              a (Java) string consisting of Unicode characters (internal encoding: UTF-16)</li>
 * <br/>
 * <br/>
 ...
 * use your own property types deriving one of these basic property types.
 * <br/>
 * <br/>
 * @see RapidBean
 *
                            ...
                            try {
                                ...
                                if (o2 instanceof LinkFrozen) {
                                    throw new RapidBeansRuntimeException("Other bean property "
                                            ...
                                            + ", link to bean " + ((TypePropertyCollection) prop.getType()).getTargetType().getName()
