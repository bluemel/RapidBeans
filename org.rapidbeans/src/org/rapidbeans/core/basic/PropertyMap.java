...
/**
 * A <b>Collection</b> bean property encapsulates a collection
 * of beans.<br/>
 * Map is similar to collection.
 * You can easily define associations between beans that then
...
public class PropertyMap extends PropertyAssociationend {
    ...
    public Map<String, Link> createNewMap() {
        ...
        try {
            newMap = (Map<String, Link>) ((TypePropertyMap)
            this.getType()).getMapClassConstructor().newInstance(MAP_CONSTR_ARGS);
     ...
     * @param validate switch that allows turning off validation
     *        Caution: handle with very much care.
...
//            for (Link curLink : this.value.values()) {
//                if (touchInverseLinks && curLink instanceof RapidBean) {
//                    addInverseLink((RapidBean) curLink, true, checkContainerLinksToExternalObjects);
//                }
//            }
//        }
//
...
//                    if (obj == null) {
//                        throw new ValidationException("invalid.prop.collection.contentnull",
//                                "invalid null object");
...
//                    if (container == null) {
//                        throw new RapidBeansRuntimeException("tried to associate a bean living outside a container"
//                                + " with one inside a container");
//                    } else {
...
//                    final Collection<RapidBean> inverseColPropValue = (Collection<RapidBean>) inverseColProp.getValue();
...
//                        };
//                        throw new ValidationException("invalid.prop.collection.add.target.alreadey.added",
...
//        final Map<Object, Link> map = (Map<Object, Link>) super.validate(newCollection);
...
//        TypePropertyCollection collectionType = (TypePropertyCollection) this.getType();
//        if (bean != null) {
