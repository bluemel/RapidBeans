...
public abstract class ContainerImpl implements Container {
     ...
     * @param implicitly special for documents.
     ...
     *        <li>
     *        Find all composition collection properties that have
     *        the type of the bean to insert as target type.
     *        </li><li>
     *        If there is exactly one add the bean there.
