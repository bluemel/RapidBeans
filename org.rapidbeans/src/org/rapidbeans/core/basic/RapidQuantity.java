...
public abstract class RapidQuantity
    ...
    public static final RapidQuantity createInstance(
        ...
        if (clazz != null) {
            try {
                final Constructor<RapidQuantity> constr = (Constructor<RapidQuantity>) clazz.getConstructor(CONSTR_PARAMTYPES_STRING);
    ...
    public static final RapidQuantity createInstance(
        ...
        if (clazz != null) {
            try {
                final Constructor<RapidQuantity> constr = (Constructor<RapidQuantity>) clazz.getConstructor(CONSTR_PARAMTYPES_MAG_UNIT);
