 ...
 * <it> <li><b>A</b>wareness: Both objects are aware of the fact that the relationship exists even if the is only one way navigability. That means an association between instance A and B will be automatically deleted if one of the instances is deleted.</li> <li><b>B</b>oolean existence: If the partners agree to a divorce, the relationship (in UML called the link) is dissolved completely.</li> <li><b>A</b>greement: Both objects have to agree with the relationship; they need to say "I do."</li>
 * <li><b>C</b>ascaded deletion: If one of the partners dies, the relationship is dissolved as well. That means the two links between instance A and B will be automatically deleted if one of the instances is deleted.</li> <li><b>US</b>e of <b>role names</b>: An object may refer to its partner using the role name provided with the association: "my husband" or "my wife." Therefore every association end defines with its property name a so called role name.</li> </it><br/>
 * <br/>
 ...
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Must be a positive integer or -1 which means "unlimited". The default value for this property is -1.<br/>
 * <br/>
 ...
 * more detailed. <li><b>qualified:</b> { true | false }</li> <li><b>flavor:</b> { set | bag }</li> <li><b>ordering:</b> { byId, byPropertyValuesAll, byPropertyValues }</li>
 * 
 * <br/>
 * 
 * <br/>
