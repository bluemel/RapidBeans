 ...
 */
public class ImmutableCollectionException extends RapidBeansRuntimeException {
	 ...
	 */
	public ImmutableCollectionException() {
		super("a ReadonlyListCollection may not be modified");
	}
}
