...
public abstract class TypeProperty {
     ...
     *
     * @param argValue the default value instance
     */
     ...
     *
     * @param propertyNode the XML DOM node with the property's type description
     * @param propertyNode the XML DOM node with the property's XML binding
     * @param bizBeanType the parent bizBeanType
     *
     ...
     * constructor.
     *
     * @param typeId       the property's type id { string, choice, ... }
     * @param propertyNodes the XML nodes describing the property.
     * @param parentType the parent bean type
     */
