...
public class TypePropertyCollection extends TypeProperty {
     ...
     */
    public static final Class<?> DEFAULT_COLLECTION_CLASS_DEFAULT
        = ArrayList.class;
    ...
    public TypePropertyCollection(
        ...
        this.targetType = (TypeRapidBean) RapidBeansTypeLoader.getInstance().loadType(TypeRapidBean.class, targetTypeName);
                ...
                for (String propname : StringHelper.split(sSorting.substring(iColon + 1), ",")) {
                    ...
                    if (proptype == null) {
                        throwModelValidationException(
                                "Invalid ordering property \"" + propname
