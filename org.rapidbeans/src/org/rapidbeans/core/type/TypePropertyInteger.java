...
public final class TypePropertyInteger extends TypePropertyNumber {
    ...
    private Class<?> sizeToNumberClass(final IntegerSize size) {
        switch (size) {
        case byte01: return Byte.class;
        case byte02: return Short.class;
        case byte04: return Integer.class;
        case byte08: return Long.class;
        case unlimited: return BigInteger.class;
        default: throw new RapidBeansRuntimeException("Unknown integer size \""
                + size.toString() + "\"");
        }
    }
     ...
     * @param integerValue the object to convert
    ...
    public Number convertValue(final PropertyInteger prop, final Object integerValue) {
        ...
        case none: break;
        default: throw new RapidBeansRuntimeException(
