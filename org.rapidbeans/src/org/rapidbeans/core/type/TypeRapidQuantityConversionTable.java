...
public final class TypeRapidQuantityConversionTable {
     ...
     *
     * @param argUnitType the enum type wich is the quantity type's unit.
     * @param argDescr the String containing the conversion factors of each unit.
    ...
    public TypeRapidQuantityConversionTable(final TypeRapidEnum argUnitType, final String argDescr) {
        ...
        for (i = 0; i < sa.length; i++) {
            ...
            log.fine("      recip = [" + unit + "," + this.units.length + "," + unit.ordinal() + "] = " + this.conversionFactorTableReciprocalFlag[this.units.length][unit.ordinal()]);
                ...
                if (f1 != null && f2 != null) {
                    if ((!r1) && (!r2)) {
                        ...
                        case 0:
                            ...
                            break;
                        default:
                            throw new RapidBeansRuntimeException("compare unexpectedly deliverd value " + f1.compareTo(f2));
                        }
                    } else if ((!r1) && r2) {
     ...
     *
     * @param fromUnit the source unit of the conversion
     * @param toUnit   the target unit of the conversion
