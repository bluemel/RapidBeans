...
public class MessageDialogSwing extends MessageDialog {
    ...
    public final MessageDialogResponse messageYesNoCancel(final String message, final String title) {
        ...
        switch (confirm) {
        case JOptionPane.YES_OPTION: return MessageDialogResponse.yes;
        case JOptionPane.NO_OPTION: return MessageDialogResponse.no;
        default: return MessageDialogResponse.cancel;
        }
    }
