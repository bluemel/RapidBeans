...
public final class DocumentTreeModel implements TreeModel {
     ...
     * <code>parent</code> must be a node previously obtained
     * from this data source. This should not return <code>null</code>
     * if <code>index</code> is a valid index for <code>parent</code>
     ...
     *
     * @param parent the bean or PropertyCollection tree node.
    ...
    public int getChildCount(final Object parent) {
        ...
        if (parent instanceof RapidBean) {
            ...
            final Collection<RapidBean> col = (Collection<RapidBean>) ((DocumentTreeNodePropCol) parent).getColProp().getValue();
            if (col == null) {
                count = 0;
            } else {
                if (this.beanFilter == null) {
     ...
     *
     * @param argObject the object: ether a bean or a BBPropCollctionTreeNode
     * @param includeObjectSelf if the object given should also be included in the path
     *
     * @return the Object array which is empty if there isn't any parent
     */
    protected Object[] getParentObjects(final Object argObject,
            final boolean includeObjectSelf) {
        ...
        while (o != null) {
            if (o instanceof RapidBean) {
                ...
                if (o instanceof RapidBean) {
                    PropertyCollection parentProp = ((DocumentTreeNodeBeanLink) o)
                        .getLinkedBean().getParentProperty();
                    if (parentProp == null) {
                        o = null;
                    } else {
     ...
     */
    protected void fireBeansInserted(final TreePath path,
            final int[] childIndices, final RapidBean[] beans) {
     ...
     * @param beans the child objects
     */
    protected void fireBeansDeleted(final TreePath path,
            final int[] childIndices, final RapidBean[] beans) {
        TreeModelEvent e = new TreeModelEvent(this, path, childIndices, beans);
        for (TreeModelListener listener : this.listeners) {
