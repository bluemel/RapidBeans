...
public final class MainWindowSwing extends MainWindow {
    ...
    public void setCursor(final CursorStyle style) {
        Cursor cursor = null;
        switch (style) {
        case defaultcursor: cursor = defaultCursor; break;
        case wait: cursor = waitCursor; break;
        default: throw new RapidBeansRuntimeException("invalid cursor style " + style.toString());
        }
