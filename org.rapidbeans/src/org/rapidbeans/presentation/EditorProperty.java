...
public abstract class EditorProperty
     ...
     * @param bakProp the bean backup property
...
//        String proptypename = proptype.name();
        ...
        if (classname == null) {
            ...
            case quantity:
                ...
                if ((Currency.dollar).getType() ==
                    qProptype.getQuantitytype().getUnitInfo()) {
                    widgetname = "Money";
                } else {
                    widgetname = "Quantity";
                }
     ...
     *
     * @param prop the bean property to edit
     * @param bakProp the backup property used instead of
     *                 a transaction
