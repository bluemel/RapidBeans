...
public class Action extends RapidBeanImplStrict {
     ...
     *
     * @param name the argument name
     * @param defaultval the default value if the argument is not defined
     *
     * @return the value of the action argument with the given name
    ...
    public String getMessage() {
        ...
        if (message == null) {
            message = app.getCurrentLocale().getStringMessage(
                    "action.execution." + getState().name(),
     ...
     * @param argValue value of Property 'classname' to set
     */
     ...
     * @param argValue value of Property 'arguments' to set
     */
     ...
     * @param argValue value of Property 'state' to set
     */
     ...
     * @param argValue value of Property 'rolesrequired' to set
     */
