...
public class Filter {
     ...
     *
     * @param includesRule a query that describes the objects to include
     */
     ...
     *
     * @param excludesRule a query that describes the objects to exclude
     */
    ...
    public void setDocument(final Document doc) {
        ...
        if (this.includesRules != null && this.includesRules.size() > 0) {
            for (final Query includesRule : this.includesRules) {
                if (includesRule.getQueryExpressionTreeRoot() instanceof QueryExprConditionType) {
                    final String typename = ((QueryExprConditionType) includesRule.getQueryExpressionTreeRoot()).getTypename();
        ...
        for (final Query excludesRule : this.excludesRules) {
            ...
            if (excludesRule.getQueryExpressionTreeRoot() instanceof QueryExprConditionType) {
                final String typename = ((QueryExprConditionType) excludesRule.getQueryExpressionTreeRoot()).getTypename();
                if (this.typeMap.get(typename) != null
