...
public class Document extends ContainerImpl {
     ...
     *            <li>false: the original encoding will be preferred if not
     *            null</li>
     * @param useUrl
     ...
     *            <li> Find all composition collection properties that have the
     *            type of the bean to insert as target type. </li>
