...
public final class BeanCompositeCreateRuntimePerfTest extends TestCase {
    ...
    public void setUp()
        ...
        if (!this.isWarmedUp) {
            ...
            Thread.sleep(100);
            Submenu menu0 = (Submenu) RapidBean.createInstance("org.rapidbeans.presentation.Submenu");
     ...
     * runtime test.
     *
     * @param count number of components to create in the composite
     * @param timeExpectedMax expected runtime
     *
     * @throws InterruptedException because we use Thread.sleep().
     */
    private void testBeanCompositeTreeHeap(final int count, final long timeExpectedMax)
        ...
        Thread.sleep(100);
        Submenu menu1 = (Submenu) RapidBean.createInstance("org.rapidbeans.presentation.Submenu");
     ...
     * test helper.
     *
     * @param menu  the menu to create submenus for.
    ...
    private void createSubmenus(final Submenu menu, final long count) {
        ...
        for (int i = 1; i < count; i++) {
            item = (MenuItem) RapidBean.createInstance("org.rapidbeans.presentation.MenuItem");
