...
public final class BeanCompositionTreeMemoryPerfTest extends TestCase {
    ...
    public void testBeanCompositeTreeHeap()
        ...
        Thread.sleep(100);
        Submenu menu2 = (Submenu) RapidBean.createInstance("org.rapidbeans.presentation.Submenu");
        try {
        ...
        Thread.sleep(100);
        menu2 = (Submenu) RapidBean.createInstance("org.rapidbeans.presentation.Submenu");
        createSubmenus(menu2, count);
