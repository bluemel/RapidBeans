...
public final class TypePropertyBoolean extends TypeProperty {
	 ...
	 * 
	 * @param sBool the boolean String to validate.
	 */
	 ...
	 * converter.
	 * 
	 * @param newValue the object to convert. It must be an instance of the
	 *                 following classes:
	 *                 <li><b>Boolean:</b> the boolean value itself</li>
	 *                 <li><b>String:</b> the boolean as string { 'false' | 'true'
	 *                 }</li>
	 * 
	...
	public Boolean convertValue(final Object newValue) {
		...
		if (newValue instanceof Boolean) {
			...
			throw new ValidationException("invalid.prop.boolean.type", this,
					"Property \"" + this.getPropName() + "\": " + "invalid data type \"" + newValue.getClass().getName()
