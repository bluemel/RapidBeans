...
public final class TypePropertyMap extends TypePropertyCollection {
	 ...
	 * 
	 * @param defMapClass the default map class
	 */
	...
	/**
	 * the map class used for implementing this association role. The default is a
	 * HashMap
	 */
	 ...
	 * 
	 * @param xmlNodes       the XML DOM nodes with the property type description.
			...
			try {
				...
				if (!ClassHelper.classOf(Collection.class, this.mapClass)) {
					throw new RapidBeansRuntimeException(
							"Invalid collectionclass: Class \"" + mapClassname + " is not a Collection.");
				}
