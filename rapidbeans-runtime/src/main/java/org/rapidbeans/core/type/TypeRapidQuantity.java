...
public class TypeRapidQuantity extends RapidBeansType {
	 ...
	 * 
	 * @param typename the quantity type name
	 */
	 ...
	 * Constructor for TypeRapidQuantity.
	 * 
	 * @param clazz             the quantity type class
	 * @param typeDescrRootNode the quantity type description
	 */
	 ...
	 * 
	 * @param quantityClass the quantity's class.
	 * 
	 ...
	 * 
	 * @param descr the XML type description
	 * 
	 ...
	 * @return null if the quantity with the specified type name could not be found
	 *         and a concrete quantity class could not be loaded
	 */
	...
	private static void validateString(final String s, final String entityname, final String attrname) {
		...
		if (s.equals("")) {
			throw new RapidBeansRuntimeException(
					"Error parsing XML quantity description." + "  Entity <quantitytype>: attribute \"name\" is empty");
		}
	}
}
