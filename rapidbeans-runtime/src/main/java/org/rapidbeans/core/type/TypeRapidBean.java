...
public final class TypeRapidBean extends RapidBeansType {
	...
	/**
	 * Find's a bean type instance out of it's name and loads it if it's not already
	 * loaded.
	 * 
	 * @param typename the Bizbean's type name
	 * 
	...
	/**
	 * Mapping of this RapidBean type to an XML element. Specifies the name of the
	 * root element of an XML document if a bean of this type is root of a document.
	 */
	private String xmlRootElement = null;

	/**
	 * Maps this RapidBean type to an XML element. This mapping specifies the name
	 * of the root element of an XML document if this bean is root of a document.
	 * 
	 ...
	 * 
	 * @param xmlRootElement the XML element name
	 * 
	 ...
	 * 
	 * @param clazz           the bean's class
	 * @param typeDescr       the RapidBean type description's top level node
	 * @param xmlBindingDescr the XML binding description's top level node
	 * @param register        specifies if the type should be registered
	 */
				...
				if (superPropType != null) {
					if (this.isFinal || propertyType.getFinal()) {
						throw new RapidBeansRuntimeException(
								"Error while initializing" + " bean type \"" + this.getName() + "\": final property \""
										+ propertyType.getPropName() + "\" may not be overriden.");
					}
	 ...
	 * 
	 * @param xmlBindingDescr the XML Node with the binding description
	 */
	 ...
	 * 
	 * @param supertype the same or super type.
	 * @param comptype  the type to test if same or sub type
	 * 
	 ...
	 * @param plural          determines if the plural is required
	 * @param defaultTypename if null the type's short name is returned
	 * 
	 ...
	 * 
	 * @param concreteSubtpyes the list into which we collect
	 */
