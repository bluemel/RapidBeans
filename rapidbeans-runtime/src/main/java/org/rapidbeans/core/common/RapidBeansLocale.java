...
public class RapidBeansLocale extends RapidBeanImplStrict {
	 ...
	 * 
	 * @param key  the resource key
	 * @param arg1 the string to insert
	 * 
	 * @return the localized string
	 */
	 ...
	 * @param key  the resource key
	 * @param arg1 the string to insert
	 * @param arg2 the string to insert
	 * 
	 * @return the localized string
	 */
	...
	/**
	 * return the localized string for a given resource key while inserting three
	 * strings.
	 * 
	 * @param key  the resource key
	 * @param arg1 the string to insert
	 * @param arg2 the string to insert
	 * @param arg3 the string to insert
	 * 
	 * @return the localized string
	 */
	 ...
	 * 
	 * @param s         one extension
	 * @param textsName another extension
	 * 
