...
public class PropertyBoolean extends Property {
	...
	/**
	 * The Boolean value. !!! do not initialize here because the superclass does it
	 ...
	 *                 <b>String:</b> the boolean as string { 'false' | 'true'
	 *                 }<br/>
	 */
	 ...
	 * converter.
	 * 
	 * @param booleanValue the object to convert. It must be an instance of the
	 *                     following classes: <il>
	 *                     <li><b>Boolean:</b> the boolean value itself<br/>
	 *                     </li>
	 *                     <li><b>String:</b> the boolean as string { 'false' |
	 *                     'true' }</li> </il>
	 * 
