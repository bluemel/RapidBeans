...
public abstract class Id implements Comparable<Id> {
	 ...
	 * factory method.
	 * 
	 * @param idString the id in String form.
	 * @param bean     the parent bean for this id.
	...
	public static Id createInstance(final RapidBean bean, final String idString) {
		...
		try {
			...
			throw new RapidBeansRuntimeException(
					"Id class \"" + classname + "\" does not have a constructor with String");
		} catch (IllegalArgumentException e) {
			throw new RapidBeansRuntimeException(
					"IllegalArgumentException while trying" + " to create instance for Id class \"" + classname, e);
		} catch (InstantiationException e) {
			throw new RapidBeansRuntimeException(
					"InstantiationException while trying" + " to create instance for Id class \"" + classname, e);
		} catch (IllegalAccessException e) {
			throw new RapidBeansRuntimeException(
					"IllegalAccessException while trying" + " to create instance for Id class \"" + classname, e);
		} catch (InvocationTargetException e) {
			throw new RapidBeansRuntimeException(
					"InvocationTargetException while trying" + " to create instance for Id class \"" + classname, e);
		}
		return id;
	}
	 ...
	 * 
	 * @param o the Id to compare with
	 * 
