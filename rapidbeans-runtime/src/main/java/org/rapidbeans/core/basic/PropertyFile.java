...
public class PropertyFile extends Property {
	...
	/**
	 * the property's File value. !!! do not initialize here because the superclass
	 ...
	 * 
	 * @param fileValue the new value for this property.<br/>
	 *                  Must be an instance of the following class:<br/>
	 *                  <b>File:</b> a File<br/>
	 *                  <b>String:</b> a String describing a absolute or relative
	 *                  path to the file<br/>
	 */
	...
	public File convertValue(final Object argValue) {
		...
		if (argValue instanceof File) {
			...
			throw new ValidationException("invalid.prop.string.type", this, "Tried to convert value from a data type \""
	...
	public File validate(final Object newValue) {
		...
		if (type.getMustExist() && !file.exists()) {
			...
			case file:
				throw new ValidationException("invalid.prop.dir.notexists", this,
						"File \"" + file.getAbsolutePath() + "\" does not exist.", messageArgs);
			case link:
				throw new ValidationException("invalid.prop.link.notexists", this,
						"File \"" + file.getAbsolutePath() + "\" does not exist.", messageArgs);
			default:
				throw new ValidationException("invalid.prop.file.notexists", this,
						"File \"" + file.getAbsolutePath() + "\" does not exist.", messageArgs);
			}
		}
		...
		if (type.getFiletype() != null && file.exists()) {
			...
			case file:
				if (!file.isFile()) {
					throw new ValidationException("invalid.prop.file.nofile", this,
							"File \"" + file.getAbsolutePath() + "\" is not a plain file.");
				}
				break;
			case directory:
				if (!file.isDirectory()) {
					throw new ValidationException("invalid.prop.file.nodir", this,
							"File \"" + file.getAbsolutePath() + "\" is not a directory.");
				}
				break;
			case fileordir:
				if ((!file.isDirectory()) && (!file.isFile())) {
					throw new ValidationException("invalid.prop.file.nofileordir", this,
