...
public final class IdTransientid extends Id {
	 ...
	 * 
	 * @param bean the reference
	 * @param s    not used for transient IDs.
	 */
	 ...
	 * 
	 * @param id the object to comapare with
	 * @return -1, 0, 1
	 */
	public int compareTo(final IdTransientid id) {
		return Integer.valueOf(this.reference.hashCode()).compareTo(Integer.valueOf(id.reference.hashCode()));
	}
}
