...
public final class PropertyInteger extends PropertyNumber {
	 ...
	 * 
	 * @param newValue the new integer value for this property.<br/>
	...
	public Number validate(final Object newValue) {
		...
		if (maxValue != null) {
			...
			if (exceeded) {
				throw new ValidationException(
						"invalid.prop.integer.maxval", this, "invalid integer \"" + newNumberValue.toString()
		...
		if (minValue != null) {
			...
			if (exceeded) {
				throw new ValidationException(
						"invalid.prop.integer.minval", this, "invalid integer \"" + newNumberValue.toString()
