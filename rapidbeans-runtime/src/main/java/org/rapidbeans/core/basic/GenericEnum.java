...
public class GenericEnum implements Cloneable, Comparable<RapidEnum>, RapidEnum {
	...
	/**
	 * Generic instance finder for enums. Provides a generic way to retrieve certain
	 * enum elements.<br/>
	 * Instead of<br/>
	 * <code>RapidEnum enum = Length.m</code> you can also code<br/>
	 * <code>RapidEnum enum = RapidEnum.getInstance("org.rapidbeans.domain.math.Length", "m")</code>
	 * <br/>
	 * <p>
	...
	/**
	 * one and only common constructor for RapidBeans RapidEnum elements. Must only
