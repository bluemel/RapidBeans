 ...
 * <li><b> <code>association (end)</code></b> a collection of references to
 * other beans (Links)</li>
 * <li><b><code>boolean&nbsp&nbsp&nbsp&nbsp</code></b>a boolean value ('true' or
 * 'false')</li>
 * <li><b> <code>choice&nbsp&nbsp&nbsp&nbsp&nbsp</code></b>(multiple) choice of
 * enum entries (RapidEnum)</li>
 * <li><b> <code>date&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</code></b>a date</li>
 * <li><b> <code>decimal (not yet implemented)&nbsp&nbsp&nbsp&nbsp</code>
 * </b>numeric value stored in decimal format (BigDecimal)</li>
 * <li><b> <code>file&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</code></b>File or
 * Directory</li>
 * <li><b><code>float (not yet implemented)&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</code>
 * </b>numeric value stored in floating point format (double)</li>
 * <li><b> <code>integer&nbsp&nbsp&nbsp&nbsp</code></b>numeric value stored in
 * integer format (long)</li>
 * <li><b><code>quantity&nbsp&nbsp&nbsp</code></b>quantity consisting in
 * magnitude (Number) and unit (RapidEnum)</li>
 * <li><b> <code>string&nbsp&nbsp;&nbsp&nbsp&nbsp</code></b> a (Java) string
 * consisting of Unicode characters (internal encoding: UTF-16)</li> <br/>
 * <br/>
...
public abstract class Property implements Cloneable, Comparable<Property> {
	 ...
	 * 
	 * @param type       the type info (constraints) for this property
	 * @param parentBean the parent bean
	 * 
	 ...
	 * 
	 * @param value the value object to convert. Every property has to support at
	...
	/**
	 * Check if the property's (initial) value is valid. Remember that properties
	 * never are allowed to get invalid values.
	 */
	...
	/**
	 * The basic property validation. Should be called with super.validate by every
	 * overloaded validate method.<br>
	...
	public Object validate(final Object newValue) {
		...
		if (this.getReadonly() && ThreadLocalValidationSettings.getReadonlyCheck()) {
			throw new ValidationReadonlyException("invalid.prop.readonly.proptype", this,
		...
		if (newValConverted == null && this.type.getMandatory() && ThreadLocalValidationSettings.getMandatoryCheck()) {
			if (this.getBean() != null) {
				throw new ValidationMandatoryException("invalid.prop.mandatory", this,
						"Bean \"" + this.getBean().getType().getName() + "::" + this.getBean().toString() + ", "
								+ "Property \"" + this.getType().getPropName() + "\": "
								+ "an empty (null) value must not be written" + " to a mandatory property");
			} else {
				throw new ValidationMandatoryException("invalid.prop.mandatory", this,
						"Property \"" + this.getType().getPropName() + "\": "
								+ "an empty (null) value must not be written" + " to a mandatory property");
	 ...
	 * 
	 * @param prop the other Property to compare this Property with
	 * 
							...
							try {
								...
								if (o1 instanceof LinkFrozen) {
									throw new RapidBeansRuntimeException(
											"This bean property " + this.getBean().getType().getName() + "::"
													+ this.getBean().getIdString() + "." + this.getName() + ", link to "
													+ ((LinkFrozen) o1).getIdString() + " is not resolved.");
								}
								if (o2 instanceof LinkFrozen) {
									throw new RapidBeansRuntimeException(
											"Other bean property " + prop.getBean().getType().getName() + "::"
													+ prop.getBean().getIdString() + "." + prop.getName()
													+ ", link to bean " + ((TypePropertyCollection) prop.getType())
	...
	/**
	 * the test for equality of two properties. Handles empty values and delegates
	 * test to the value objects if both are not empty.
	 * 
	 * @param o the property to compare this property with
	 * 
	 ...
	 * 
	 * @param pClone         the property that receives the cloned value
	 * @param cloneContainer the container for the cloned property's sub beans
	 * 
