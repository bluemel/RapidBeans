...
public class BeanSorter {
	...
	/**
	 * @param props the thread local property sorter to apply
	 */
	 ...
	 * creates a sorter.
	 * 
	 * @param proptypes the property types in sort order
	 */
	public BeanSorter() {
	 ...
	 * 
	 * @param proptype the type of the property to take as sorting criteria
	 */
	 ...
	 * 
	 * @param beans the collection to sort
	 * 
