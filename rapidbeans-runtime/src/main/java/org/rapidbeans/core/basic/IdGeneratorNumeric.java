...
public final class IdGeneratorNumeric implements IdGenerator {
	...
	/**
	 * notify the number generator that an ID exists so that the max gen number will
	 * be set high enough.
	 * 
	 * @param existingId existing numeric id as int
	 */
	 ...
	 * release a number.
	 * 
	 * @param freeNumber the number to release
	 */
