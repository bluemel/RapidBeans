...
public class NumberFormat {
	 ...
	 * 
	 * The input separator and the decimal char can be given language dependent. The
	 * output is always language independent.
	 */
	 ...
	 * 
	 * @param d                  the number a BigDecimal
	 * @param locale             the locale
	 * @param numberFormatString the number format string
	 * 
	 ...
	 * 
	 * @param l                  the long integer number
	 * @param locale             the locale
	 * @param numberFormatString the number format string
	 * 
	 * @return the formatted number string
	 ...
	 * 
	 * @param sIn                the string containing the number
	 * 
