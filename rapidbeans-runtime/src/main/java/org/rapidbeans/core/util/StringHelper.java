...
public final class StringHelper {
	...
	/**
	 * Implements a more powerful mechanism to remove or filter leading and trailing
	 * characters than String.trim().<br/>
	 * Instead of simply removing whitespace characters you can specify an arbitrary
	 * character to be removed.<br/>
	 ...
	 * Implements a more powerful mechanism to remove or filter leading and trailing
	 * characters than String.trim().<br/>
	 * Instead of simply removing whitespace characters you can specify arbitrary
	 * characters to be removed.<br/>
	...
	/**
	 * Implements a more powerful mechanism to remove or filter leading and trailing
	 * whitespace characters than String.trim().<br/>
	 ...
	 * 
	 * @param string    the string to strip
	 * @param stripMode specifies if only leading or trailing characters are removed
	 ...
	 * removed.<br/>
	 * Additionally you can specify the characters are removed from both sides or if
	 * only leading or trailing characters are removed.
	 * 
	 * @param string          the string to strip
	 * @param stripCharacters specifies a list of characters to remove or filter.
	...
	/**
	 * A primitive helper for formatting strings by simply filling it up on the left
	...
	/**
	 * Split the first token from a give string using any whitespace character as
	 * delimiter.
	 * 
	 * @param string the string to split
	 * 
	...
	/**
	 * A convenient method to split a string by any whitespace character but leave
	 * quoted substring together.
	 * 
	 ...
	 * @param sIn       - string to trim
	 * @param trimChars - characters to trim
	 * @param mode      - TRIM_MODE_BOTH, TRIM_MODE_LEADING or TRIM_MODE_TRAILING
	 * @return - trimmed string
	 */
