...
public abstract class MenuEntry extends RapidBeanImplStrict {
	...
	/**
	 * create a MenuEntry of a special type out of a configuration which is the this
	 * object itself.
	 * 
	...
	public static MenuEntry createInstance(final ConfigMenuEntry cfg, final Application client,
		...
		if (cfg instanceof ConfigSubmenu) {
			...
			newEntry = MenuHistoryOpenDocument.createInstance((ConfigMenuHistoryOpenDocument) cfg, client,
					resourcePath);
