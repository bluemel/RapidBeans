...
public class EditorPropertyPwd extends EditorPropertySwing {
	...
	public EditorPropertyPwd(final Application client, final EditorBean bizBeanEditor, final Property prop,
		...
		super.initColors();
		this.button
				.setText(client.getCurrentLocale().getStringGui("editor.org.rapidbeans.security.user.pwd.button.set"));
		...
		this.buttonReset.setText(
				client.getCurrentLocale().getStringGui("editor.org.rapidbeans.security.user.pwd.button.reset"));
