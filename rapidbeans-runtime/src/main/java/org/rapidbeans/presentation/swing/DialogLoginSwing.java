...
public class DialogLoginSwing extends DialogLogin {
	...
	/**
	 * check box to indicate that the credential once given should be reused for the
	 * next login.
	 */
	...
	/**
	 * check box to indicate that the credentials to be saved should be encrypted.
	 */
	 ...
	 * constructor.
	 * 
	 * @param saveCredent    if credentials should be saved or not
	 * @param encryptCredent if credentials should be encrypted or not
	 */
	...
	/**
	 * Asks the user for confirmation if he / she really wants to save the creds.
	 */
