...
public final class ExampleFileFilter extends FileFilter {
	 ...
	 * shouldn't.
	 * 
	 * @param f the file Files that begin with "." are ignored.
	 ...
	 * 
	 * @param extension the extension to filter for For example: the following code
	...
	/**
	 * @return the human readable description of this filter. For example: "JPEG and
