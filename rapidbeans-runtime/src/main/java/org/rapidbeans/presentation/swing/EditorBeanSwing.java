...
public class EditorBeanSwing extends EditorBean {
	 ...
	 * section of the main panel with BIrderLayout causes the editor to be aligned
	 * to the upper window boundary.
	 */
	...
	/**
	 * validate and update the GUI. - the buttons enabled - the text of the close
	 * button
	 * 
	 * @param propEditor the propEditor where the input field has been changed. Give
	 *                   a null if an OK, Apply or Close button has been pressed
	 *                   instead.
	 */
	 ...
	 * 
	 * @param valid if all input values are valid or not
	 */
