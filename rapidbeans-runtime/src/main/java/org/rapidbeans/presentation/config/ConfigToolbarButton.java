/*
 * Rapid Beans Framework: ConfigToolbarButton.java
 * 
...
/**
 * Rapid Bean class: ConfigToolbarButton.
 */
public class ConfigToolbarButton extends RapidBeanBaseConfigMenuItem {
	...
	public Action getAction() {
		if (super.getChildaction() != null && super.getAction() != null) {
			throw new RapidBeansRuntimeException("Invalid configuration for menu item" + this.getName() + "either use a"
	...
	/**
	 * @return the roles required for this tool bar button either from this
	 *         configuration itself (prioritized way) or from the (central) action
	 *         definition.
	 */
	@Override
	...
	/**
	 * @return the enabler defined for this tool bar button either from this
	 *         configuration itself (prioritized way) or from the (central) action
	 *         definition.
	 */
	@Override
	 ...
	 * @param s the string
	 */
	public ConfigToolbarButton(final String s) {
		super(s);
	}
	 ...
	 */
	public ConfigToolbarButton(final String[] sa) {
		super(sa);
	}
