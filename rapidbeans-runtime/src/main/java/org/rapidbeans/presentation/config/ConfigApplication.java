...
/**
 * Rapid Bean class: ConfigApplication. Partially generated Java class !!!Do
...
public class ConfigApplication extends RapidBeanImplStrict {
	 ...
	 * @return the configuration of the document with the given name or null if not
	 *         found
	 */
	 ...
	 * 
	 * @param argValue value of Property 'rootpackage' to set
	 */
	 ...
	 * 
	 * @param argValue value of Property 'applicationclass' to set
	 */
	 ...
	 * 
	 * @param argValue value of Property 'guitype' to set
	 */
	 ...
	 * 
	 * @param argValue value of Property 'defaultlocale' to set
	 */
	 ...
	 * 
	 * @param argValue value of Property 'defaultcharset' to set
	 */
	 ...
	 * 
	 * @param argValue value of Property 'locales' to set
	 */
			...
			if (col == null || col.size() == 0) {
				...
				if (link instanceof LinkFrozen) {
					throw new UnresolvedLinkException(
							"unresolved link to \"" + "org.rapidbeans.presentation.config.ConfigBranding" + "\" \""
									+ link.getIdString() + "\"");
				} else {
	 ...
	 * 
	 * @param argValue value of Property 'branding' to set
	 */
	 ...
	 * 
	 * @param argValue value of Property 'beaneditors' to set
	 */
	 ...
	 * 
	 * @param argValue value of Property 'documents' to set
	 */
	 ...
	 * 
	 * @param argValue value of Property 'actions' to set
	 */
	...
	public org.rapidbeans.presentation.config.ConfigMainWindow getMainwindow() {
		try {
			...
			if (col == null || col.size() == 0) {
				...
				if (link instanceof LinkFrozen) {
					throw new UnresolvedLinkException(
							"unresolved link to \"" + "org.rapidbeans.presentation.config.ConfigMainWindow" + "\" \""
									+ link.getIdString() + "\"");
				} else {
	...
	public org.rapidbeans.presentation.config.ConfigAuthorization getAuthorization() {
		try {
			...
			if (col == null || col.size() == 0) {
				...
				if (link instanceof LinkFrozen) {
					throw new UnresolvedLinkException(
							"unresolved link to \"" + "org.rapidbeans.presentation.config.ConfigAuthorization" + "\" \""
									+ link.getIdString() + "\"");
				} else {
	 ...
	 * 
	 * @param argValue value of Property 'authorization' to set
	 */
	...
	public org.rapidbeans.presentation.config.ConfigCurrency getCurrency() {
		try {
			...
			if (col == null || col.size() == 0) {
				...
				if (link instanceof LinkFrozen) {
					throw new UnresolvedLinkException(
							"unresolved link to \"" + "org.rapidbeans.presentation.config.ConfigCurrency" + "\" \""
									+ link.getIdString() + "\"");
				} else {
	 ...
	 * 
	 * @param argValue value of Property 'currency' to set
	 */
	...
	public org.rapidbeans.presentation.config.ConfigXmlBinding getXmlbinding() {
		try {
			...
			if (col == null || col.size() == 0) {
				...
				if (link instanceof LinkFrozen) {
					throw new UnresolvedLinkException(
							"unresolved link to \"" + "org.rapidbeans.presentation.config.ConfigXmlBinding" + "\" \""
									+ link.getIdString() + "\"");
				} else {
	 ...
	 * 
	 * @param argValue value of Property 'xmlbinding' to set
	 */
