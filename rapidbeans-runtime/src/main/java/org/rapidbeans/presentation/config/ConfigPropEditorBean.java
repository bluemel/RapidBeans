...
public class ConfigPropEditorBean extends RapidBeanImplStrict {
	 ...
	 * 
	 * @param the name of the argument to get the value for
	 * 
			...
			if (col == null || col.size() == 0) {
				...
				if (link instanceof LinkFrozen) {
					throw new UnresolvedLinkException(
							"unresolved link to \"" + "org.rapidbeans.presentation.config.ConfigPropEditor" + "\" \""
									+ link.getIdString() + "\"");
				} else {
	 ...
	 * 
	 * @param argValue value of Property 'editor' to set
	 */
	 ...
	 * 
	 * @param argValue value of Property 'nullbehaviour' to set
	 */
	 ...
	 * 
	 * @param argValue value of Property 'detail' to set
	 */
