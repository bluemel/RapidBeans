...
public class ConfigMenuItem extends RapidBeanBaseConfigMenuItem {
	...
	/**
	 * @return the roles required for this menu item either from this configuration
	 *         itself (prioritized way) or from the (central) action definition.
	 */
	@Override
	...
	/**
	 * @return the enabler defined for this menu item either from this configuration
	 *         itself (prioritized way) or from the (central) action definition.
	 */
	@Override
