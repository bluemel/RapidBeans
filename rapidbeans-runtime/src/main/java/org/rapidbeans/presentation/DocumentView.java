...
public abstract class DocumentView
	...
	/**
	 * @return the configured persistence strategy if any or 'ondemand' per default
	 */
	...
	protected DocumentView(final Application clnt, final Document doc, final String docconfname,
		...
		if (clnt.getConfiguration() != null) {
			this.configuration = clnt.getConfiguration().getConfigView(this.getConfigDocument().getName(),
					viewconfname);
		}
