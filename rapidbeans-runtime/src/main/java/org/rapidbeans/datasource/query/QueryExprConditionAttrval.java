...
class QueryExprConditionAttrval extends QueryExpression {
	...
	/**
	 * getter for the comparison operator. Needed to differ between a match and a
	 ...
	 * constructor.
	 * 
	 * @param argAttrName     the property name
	 * @param argCompOperator the comparison operator
	 * @param argParent       the parent regular expression
	 */
	 ...
	 * 
	 * @param pattern the Java regular expression
	 */
