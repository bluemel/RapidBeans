...
abstract class QueryExpression {
	...
	/**
	 * break up the parent expsession link. Used to avoid cyclic dependencies after
	 * parsing.
	 */
	 ...
	 * 
	 * @param argParentExpression the new parent expression
	 */
	 ...
	 * @param selectionIn the object found so far
	 * 
	 ...
	 * 
	 * @param childExpression the child expression to add.
	 */
	 ...
	 * 
	 * @param childExpression the child expression to remove.
	 */
	 ...
	 * 
	 * @param sIn            the string dumped so far
	 * @param ipDepth        the depth within the expression tree
	 * @param bpParentIsLast the flag if the parent is last
	 * @param bpIsLast       the flag if the expression itself is the last
	 * @param spIndentIn     the indentation string
	 * 
