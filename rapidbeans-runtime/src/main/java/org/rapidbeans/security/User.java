...
public class User extends RapidBeanImplStrict {
	 ...
	 * Hash a pwd.
	 * 
	 * @param pwdIn            the pwd to hash
	 * @param pwdHashAlgorithm the hash algorithm used
	 * 
...
//		return pwdHashed;
	 ...
	 * 
	 * @param argValue         value of Property 'pwd' to set
	 * @param pwdHashAlgorithm specify the hash algorithm used or null if you do not
	 *                         want to hash
	 */
	...
	/**
	 * Generic role check. Works for concrete User instances as well as for generic
	 * ones.
	 * 
	 * @param authenticatedUser the concrete or generic user instances
	 * @param string            the
	 * 
	 * @return
	 */
	...
	public void initProperties() {
		...
		this.changePwdAfterNextLogon = (org.rapidbeans.core.basic.PropertyChoice) this
				.getProperty("changePwdAfterNextLogon");
	 ...
	 * 
	 * @param argValue value of Property 'accountname' to set
	 */
	 ...
	 * 
	 * @param argValue value of Property 'changePwdAfterNextLogon' to set
	 */
	public void setChangePwdAfterNextLogon(final org.rapidbeans.security.ChangePwdAfterNextlogonType argValue) {
		java.util.List<org.rapidbeans.security.ChangePwdAfterNextlogonType> list = new java.util.ArrayList<org.rapidbeans.security.ChangePwdAfterNextlogonType>();
		list.add(argValue);
	 ...
	 * 
	 * @param argValue value of Property 'roles' to set
	 */
