...
public class PropertyStringTest extends TestCase {
	...
	public void testDefaultAndGetValue() {
		PropertyString prop = this
				.createStringProperty("<property name=\"test\" type=\"string\"" + " default=\"test1\"" + "/>");
	...
	public void testDefaultValueInvalid() {
		try {
			this.createStringProperty(
					"<property name=\"test\" type=\"string\"" + " maxlen=\"1\" default=\"xx\"" + "/>");
	...
	public void testToString() {
		PropertyString prop = this
				.createStringProperty("<property name=\"test\" type=\"string\"" + " default=\"test3\"" + "/>");
	...
	public void testSetValueNull() {
		PropertyString prop = this
				.createStringProperty("<property name=\"test\" type=\"string\"" + " default=\"xxx\"/>");
	...
	public void testConvertInvalid() {
		...
		assertEquals("123", prop.convertValue("123"));
	}
	...
	public void testValidateOk() {
		PropertyString prop = this.createStringProperty(
				"<property name=\"test\" type=\"string\"" + " minlen=\"6\" maxlen=\"30\" pattern=\".*@.*\"" + "/>");
	...
	/**
	 * Test for validation of a String that is empty if this is explicitly allowed.
	 */
	...
	public void testCompareToGreater() {
		PropertyString prop1 = this
				.createStringProperty("<property name=\"test\" type=\"string\"" + " default=\"abc\"" + "/>");
		PropertyString prop2 = this
				.createStringProperty("<property name=\"test\" type=\"string\"" + " default=\"xyz\"" + "/>");
	...
	public void testMultiLine() {
		PropertyString prop = this
				.createStringProperty("<property name=\"test\" type=\"string\"" + " multiline=\"true\"" + "/>");
		prop.setValue("aaa\nbbb");
		assertEquals("aaa\nbbb", prop.getValue());
	}
