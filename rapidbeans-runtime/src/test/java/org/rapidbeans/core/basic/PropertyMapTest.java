...
public class PropertyMapTest extends TestCase {
	...
	public void testDefaultEmpty() {
		this.createTestBean();
		PropertyMap prop = this
				.createMapProperty("<property name=\"test\"" + " targettype=\"TestBean\"" + " default=\"\"/>");
	...
	public void testNoTargetType() {
		try {
			this.createMapProperty("<property name=\"locales\"/>");
	...
	// col.add(bean3);
	// prop.setValue(col);
	// assertEquals("Bl�mel_Martin_19641014,Bl�mel_Ulrike_19620802,Keinki_Katharina_19901119",
	// prop.toString());
	// }
	//
	// /**
	...
	// ReadonlyListCollection cps = (ReadonlyListCollection)
	// locA.getClosedons();
