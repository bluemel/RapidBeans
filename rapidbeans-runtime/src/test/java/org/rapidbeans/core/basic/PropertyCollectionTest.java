...
public class PropertyCollectionTest {
	...
	/**
	 * test adding a component bean to a composite bean and removing it afterwards
	 * using generated (production code) classes.
	 */
	@Test
	...
	/**
	 * Creating a collection property with no target type is supposed to provoke a
	...
	/**
	 * test 1 to 1 Association: User - Person. Simply set the value of a collection
	 * property that was null before.
	 * 
	 ...
	 * implementation. At least for two way navigable (binary) associations we have
	 * to postulate, that adding the same reference twice to a collection implies a
	 * multiplicity > 1 and bags on both association ends.
	 */
	@Test
	...
	/**
	 * test 1 to 1 Association: User - Person simply add one link to a collection
	 * property that was null before.
	 * 
	 * Collection Properties: - TestUser.person [0..1] - Person.user [0..1]
	 */
	 ...
	 * property with maxmult = 1. This should throw a validation exception because
	 * the maximal multiplicity would be exceeded.
	 * 
	 * 1 to 1 Association: User Person
	 * 
	 * Collection Properties: - TestUser.person [0..1] - Person.user [0..1]
	...
	/**
	 * test creating association instances by adding multiple links successively.
	 * 
	...
	/**
	 * test deleting association instances by setting new values for the collection
	 * property.
	 * 
	 * 1 to n Association: Address - Person Collection Properties: -
	 * Address.inhabitants [*] - Person.address [1]
	 ...
	 * of a document it is automatically deleted there
	 */
	@Test
	 ...
	 * getValue
	 * 
	 * @throws java.text.ParseException if parsing Assert.fails
	 */
	@SuppressWarnings("unchecked")
	@Test
