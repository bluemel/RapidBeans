...
public class PropertyQuantityTest extends TestCase {
	...
	public void testDefaultAndGetValue() {
		PropertyQuantity prop = this.createQuantityProperty(
				"<property name=\"test\" quantity=\"org.rapidbeans.domain.math.Time\"" + " default=\"2 h\"/>");
	...
	public void testToString() {
		PropertyQuantity prop = this.createQuantityProperty(
				"<property name=\"test\" quantity=\"org.rapidbeans.domain.math.Time\"" + " default=\"3600123 ms\"/>");
	...
	public void testValidateOk() {
		PropertyQuantity prop = this.createQuantityProperty(
				"<property name=\"test\" quantity=\"org.rapidbeans.domain.math.TimeOfDay\"" + " maxval=\"01:57\"/>");
	...
	public void testValidateMinValue() {
		PropertyQuantity prop = this.createQuantityProperty(
				"<property name=\"test\" quantity=\"org.rapidbeans.domain.math.TimeOfDay\"" + " minval=\"23:57:11\"/>");
		try {
