...
public final class TimeOfDayTest extends TestCase {
	...
	/**
	 * test constructor with string: simple integers with one or two digits will be
	...
	/**
	 * test constructor with string: two integers (each one or two digits separated
	 * by ':'.
	 */
	...
	/**
	 * test constructor with string: simple quntity coding coding with magnitude and
	 * unit.
	 */
