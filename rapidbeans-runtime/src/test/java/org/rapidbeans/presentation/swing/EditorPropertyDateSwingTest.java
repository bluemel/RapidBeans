...
public class EditorPropertyDateSwingTest extends TestCase {
	...
	public void testInputfieldCompletionGerman() {
		...
		// assertCompletion("2.2.200", "02.02.200", proped, df);
	...
	public void testTypingGerman() {
		...
		// assertValidTyping("29.02.200", false, false, proped);
		// assertValidTyping("29.02.200", false, false, proped);
		assertValidTyping("29.02.2000", true, true, proped);
	}
	 ...
	 * test helper.
	 * 
	 * @param uncompleteDate the uncomplete date
	 * @param completedDate  the completed date
	 * @param proped         the property editor
