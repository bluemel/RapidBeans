...
public class EditorPropertyTextSwingTest extends TestCase {
	...
	/**
	 * The default behavior is that empty strings are invalid Mandatory means that
	 ...
	 * input field. If you want to avoid that you simply set the property's default
	 * value to an empty string (see next test).
	 */
	...
	/**
	 * If empty is valid the input field always returns an empty string. Setting the
	 * property's default value to an empty string helps avoiding undefined values
	 * and having a changed input field value initially.
	 */
	...
	/**
	 * These configurations go together well. You have valid values from the start.
	 */
