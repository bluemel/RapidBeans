...
public class DialogLoginTest {
	...
	public void tearDown() {
		...
		FileHelper.copyFile(new File("src/test/resources/testsettings_backup.xml"),
				new File("src/test/resources/testsettings.xml"), true);
	}
	...
	public void testLoginFailed5() {
		...
		ApplicationManager.start(client);
		String[][] loginData = { { "herbert", "xxx" }, { "herbert", "xxx" }, { "herbert", "xxx" }, { "herbert", "xxx" },
	...
	private class ApplicationMock extends Application {
		...
		public ApplicationMock(final String pwdHalg) {
			...
			this.setSettingsDoc(new Document(new File("src/test/resources/testsettings.xml")));
		}
