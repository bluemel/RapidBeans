...
public class MergeProperties {
	...
	/**
	 * @param argOneLineComment        the string to mark the begin of a one line
	 *                                 comment
	 * @param argSectionBegin          the string to mark the begin of a code
	 *                                 section
	 * @param argSectionEnd            the string to mark the end of a code section
	 * @param argSectionUnmatchedBegin the string to mark the begin of an unmatched
	 *                                 code section
	 * @param argSectionUnmatchedEnd   the string to mark the end of an unmatched
	 *                                 code section
	 * 
	 */
