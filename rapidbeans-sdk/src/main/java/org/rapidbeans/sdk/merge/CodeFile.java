...
public abstract class CodeFile {
	 ...
	 * @param beginSection   text of line (comment) that marks the begin of a
	 *                       manually coded section.
	 * @param endSection     text of line (comment) that marks the end of a manually
	 *                       coded section
