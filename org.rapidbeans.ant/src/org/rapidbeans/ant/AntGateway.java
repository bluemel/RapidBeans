...
public final class AntGateway {
	 ...
	 * 
	 * @param proj
	 *            the projct currently Ant works on.
	 * @param argTaskName
	 *            the taskName to use
	 */
	...
	/**
	 * Constructor for tests without given project and environment. The Ant
	 * Property task member is used for caching the environment variables are
	 * cached by the Ant Property task.
	 */
	public AntGateway() {
	 ...
	 * environment by means of a properties file.
	 * 
	 * @param proj
	 *            the project that ant currently works on.
	 * @param argEnvProps
	 *            the file withe the environment varibles defined as properties.
	 */
	...
	/**
	 * Merges one generated source code file with the manual parts of a second
	 * one.
	 * 
	 * @param srcfilegen
	 *            the file with the (generated) source code
	 * @param srcfileman
	 *            the file with the manually coded parts
	 * @param destfile
	...
	/**
	 * Copies src to or over target. - if target not exists - if src is newer
	 * than target
	 * 
	 * @param src
	 *            source file
	 ...
	 *            target file
	 * @param overwrite
	 *            true if the copy should be forced
	 */
	...
	/**
	 * Applies the Ant Copy task on one directory. Mainly all files of the
	 * source directory are copied to the target directory. If one target file
	 * is already present the copy task compares the modification date of source
	 * and target. If the source is newer than the target the source is copied
	 * over the target.
	 * 
	 * @param src
	 *            the source file
	 ...
	 * 
	 * @param repFile
	 *            the file with the strings to replace.
	 * @param from
	 *            the search string.
	 * @param to
	...
	/**
	 * Excecutes a system command by means of the Ant Exec task. Consider rather
	 * to take this method for system command execution than the
	 * java.lang.Runtime class, because this class just stops the execution if
	 * the stdout buffer is full and not read.
	 * 
	 * @param executable
	 ...
	 * 
	 * @param task
	 *            the task where to set the task name
	 * @param defaultName
	 *            the default value
	 */
