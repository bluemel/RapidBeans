...
public abstract class CodeFile {
    ...
    public final CodeFilePartBody getBody(final String signature) {
        return (CodeFilePartBody) this.bodies.get(signature);
    }
    ...
    /**
     * parse the file.
     * @param oneLineComment     combination of character to mark a one line comment
     * @param beginSection        text of line (comment) that marks
     *                            the begin of a manually coded section.
     * @param endSection          text of line (comment) that marks
     *                            the end of a manually coded section
     * @throws IOException I/O problem
     */
    public final void parse(final String oneLineComment, final String beginSection,
        ...
        final LineNumberReader reader = new LineNumberReader(new FileReader(this
                .getFile()));
