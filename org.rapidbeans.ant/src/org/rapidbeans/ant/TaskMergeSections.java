 ...
 * </p>
 *
 * As you see you need three lines to mark a section that should be
 * merged:
 *
 * <p><b>- section begin comment:</b> a fix one line comment to mark the begin of
 * a section.</p>
 * <p><b>- section signature:</b> a one line comment with a string that uniqely
 * identifies the section within one code file.
 * The section signature always directly follows the section begin comment.</p>
 * <p><b>- section end comment:</b> a fix one line comment to mark the begin of
 * a section.</p>
 *
