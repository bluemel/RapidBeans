...
public final class XXsltTest {
    ...
    /**
     * Happy day test with new file.
     * This test proves.
     * - task xxslt works
     * - task mergesections works
     * - parameters work
    ...
    public void testXxsltNew() throws IOException {
        ...
        File testDir = new File("testdata/test4");
        ...
        MergeSectionsTest.assertTextFilesEquals(outfile,
                new File(testDir, "testXsltmergeResultExpected.txt"));
        ant.delete(outfile);
    }

    /**
     * Happy day test with existing file with body.
     * This test proves the preservation of a body
     * by xxslt -> mergesections.
     *
     * @throws IOException I/O Error
     */
    @Test
    public void testXxsltExisting() throws IOException {
        ...
        try {
            ...
            MergeSectionsTest.assertTextFilesEquals(inoutfile,
                    new File(testDir, "testXsltmergeResultExpected.txt"));
        } finally {
     ...
     * Happy day test with existing file with body.
     * This test proves the preservation of a body
     * by xxslt -> mergesections and in addition tests
     * the properties of the xxslt task.
     *
     * @throws IOException I/O Error
     */
    @Test
